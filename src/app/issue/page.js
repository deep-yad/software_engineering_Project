        ...
        <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
            <thead className="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" className="px-6 py-4 font-medium text-gray-900">Roll No</th>
            ...
            <tbody className="divide-y divide-gray-100 border-t border-gray-100">
                <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">220001045</td>
                    <td className="px-6 py-4">
                ...
                <tr className="hover:bg-gray-50">
                    <th className="flex gap-3 px-6 py-4 font-normal text-gray-900">
                        <div class="text-sm">
                            <div className="font-medium text-gray-700">Harrison Woods</div>
                            <div className="text-gray-400">harriswoods@iit.ac.in</div>
                        </div>
                    </th>
                    <td className="px-6 py-4">
                        <span
                ...
                <tr className="hover:bg-gray-50">
                    <th className="flex gap-3 px-6 py-4 font-normal text-gray-900">
                        <div class="text-sm">
                            <div className="font-medium text-gray-700">Robert Wells</div>
                            <div className="text-gray-400">robertw@iiti.ac.in</div>
                        </div>
                    </th>
                    <td className="px-6 py-4">
                        <span
